package io.github.cruciblemc.gradle;
...
import static io.github.cruciblemc.gradle.DevConstants.*;

public class CruciblePlugin extends DevBasePlugin {
    private String fmlDir = "forge/fml";
    private String forgeDir = "forge";
    private String bukkitDir = "bukkit";
    private String paperDir = "";
    private String glowstoneDir = "";
